    ...
    var n = "undefined" != typeof window ? window : this,
        e = (n.Glider = function (e, t) {
            ...
            if (
                ...
                for (
                    i.track = document.createElement("div"),
                        i.ele.appendChild(i.track);
        ...
        (t.updateControls = function (e) {
            ...
            1 === Math.floor(d.opt.slidesToShow) && (h = 0),
                ...
                [].forEach.call(d.slides, function (e, t) {
                    ...
                    var n =
                        Math.ceil(l) >= Math.floor(r) &&
                        Math.floor(a) <= Math.ceil(s);
                    i.toggle("visible", n),
                        n !== o &&
                            d.emit("slide-" + (n ? "visible" : "hidden"), {
                                slide: t,
                            });
                }),
                d.dots &&
                ...
                e &&
                    ...
                    (d.scrollLock = setTimeout(function () {
                        clearTimeout(d.scrollLock),
                            0.02 <
                                Math.abs(
                                    d.ele.scrollLeft / d.itemWidth - d.slide
                                ) &&
                                (d.mouseDown ||
                                    (d.trackWidth >
                                        d.containerWidth + d.ele.scrollLeft &&
