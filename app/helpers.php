...
/* Función para calcular el stock que tenemos de productos */
...
/* Función para calcular la cantidad de items agregados */
function qty_added($product_id, $color_id = null, $size_id = null)
{
    /* Cart::content() <- obtenemos todos los items almacenados en el carrito de compras */
    $cart = Cart::content();
    ...
    /* Si existe algún item en el carrito de compras */
    if ($item) {
        return $item->qty;
    } else {
        return 0;
