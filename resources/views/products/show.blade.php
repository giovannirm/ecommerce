        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <p class="text-trueGray-700 mx-6">5 
                        <i class="fas fa-star text-sm text-yellow-400"></i>
                    </p>
                    <a href="" class="text-orange-500 hover:text-orange-600 underline">39 reseñas</a>
                </div>
                <p class="text-2xl font-semibold text-trueGray-700 my-4">
                    {{ __('Coin') .' '. $product->price }}
                </p>
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="flex p-4 items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600">{{ __('Shipping Points') }}</p>
                            <p>{{ __('Receive Order') . ' ' . Date::now()->addDay(7)->locale('es')->format('l j') . ' de ' . Date::now()->addDay(7)->locale('es')->format('F')  }}</p>
                        </div>
                    </div>
                </div>
