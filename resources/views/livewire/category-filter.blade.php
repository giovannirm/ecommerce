<div>
    <div class="bg-white rounded-lg shadow-lg mb-4">
        <div class="px-6 py-2 flex justify-between items-center">
            ...
            <div class="grid grid-cols-2 border-2 border-gray-200 divide-x divide-gray-200">
                <i class="fas fa-border-all p-3 text-gray-500 cursor-pointer"></i>
                <i class="fas fa-th-list p-3 text-gray-500 cursor-pointer"></i>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-5">
        <aside>
            <h2 class="font-semibold text-center mb-2">{{ __('Subcategories') }}</h2>
            <ul>
